...
<div class="flex gap-6 max-md:flex-col container py-12">
    <div class="w-64 space-y-6 flex-shrink-0 border-zinc-50 border rounded-xl shadow-lg p-[14px_16px] bg-[#FAFAFA]">
        <CategoryFilter categories={data.categories} {selectedCategories} on:categoriesChange={handleCategoriesChange} />
        <ManufacturerFilter manufacturers={data.manufacturers} {selectedManufacturers} on:manufacturersChange={handleManufacturersChange} />
