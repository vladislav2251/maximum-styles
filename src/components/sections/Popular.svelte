    ...
    <div class="container">
        <div class="grid md:grid-cols-2 max-md:gap-5 max-md:place-items-start">
            <div class="flex flex-col gap-4 md:gap-6">
                <h2 class="text-[var(--color-black)] font-medium text-4xl  md:text-6xl">Наши популярные продукты</h2>
            ...
            <div class="flex gap-2 md:gap-4 items-center md:justify-end">
                <a href="/products">
                    <p class="underline text-2xl font-medium text-[var(--color-gray800)]">Смотреть все продукты</p>
                </a>
