    ...
    <div class="container">
        <div class="grid md:grid-cols-2 gap-8">
            <div class="flex-col flex gap-4 md:gap-7">
                ...
                <a href="/product">
                    <button type="button" class="bg-[var(--color-violet)] px-8 py-4 flex justify-between items-center transition-all duration-600 hover:bg-[var(--color-purple)]">Buy Now</button>
                </a>
            </div>
