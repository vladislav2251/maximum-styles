...
<div class="grid gap-2">
  ...
  <div class="flex flex-col items-start gap-2">
    {#if uploadedImage}
      <a data-fancybox="gallery" href={uploadedImage} class="block w-40 h-40">
        <img
          src={uploadedImage}
          alt="Загруженное изображение"
          class="w-full h-full object-cover rounded-lg border border-[var(--color-gray)] shadow-lg transition-transform duration-300 hover:scale-105"
        />
      </a>
    {:else}
      <label
