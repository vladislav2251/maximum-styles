<script>
  ...
  let currentManufacturer = data.product.manufacturer_id
  ...
  >
    ...
    >
      ...
      >
        {#each categories as category}
          <option
            value={category._id}
            selected={currentCategory === product.category_id}
      ...
      <select
        bind:value={currentManufacturer}
        id="manufacturer"
        required
        name="manufacturer"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
    ...
    >
      ...
      >
        ...
        <input
          bind:value={product.price.regular}
          id="regular_price"
          required
          name="regular_price"
          class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
        ...
        />
        <input
          bind:value={product.price.discount.regular}
          id="discount_price"
          required
          name="discount_price"
          class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      >
        ...
        <input
          bind:value={product.price.specialist}
          id="specialist_price"
          required
        ...
        />
        <input
          bind:value={product.price.discount.specialist}
    ...
    >
      ...
      <textarea
        bind:value={product.description.detail.de}
        id="detail_de"
        required
        name="detail_de"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      ></textarea>
      <textarea
        bind:value={product.description.short.de}
        id="short_de"
        required
        name="short_de"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      ></textarea>
      <textarea
        bind:value={product.description.usage.de}
        id="usage_de"
        required
        name="usage_de"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      ></textarea>
      <textarea
        bind:value={product.description.ingredients.de}
        id="ingredients_de"
        required
        name="ingredients_de"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
    ...
    >
      ...
      <textarea
        bind:value={product.description.detail.bg}
        id="detail_bg"
        required
        name="detail_bg"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      ></textarea>
      <textarea
        bind:value={product.description.short.bg}
        id="short_bg"
        required
        name="short_bg"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      ></textarea>
      <textarea
        bind:value={product.description.usage.bg}
        id="usage_bg"
        required
        name="usage_bg"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
      ...
      ></textarea>
      <textarea
        bind:value={product.description.ingredients.bg}
        id="ingredients_bg"
        required
        name="ingredients_bg"
        class="px-8 py-4 border-solid outline-none text-base w-full md:w-3/4 border font-normal border-[var(--color-gray)] rounded-md text-[var(--color-gray)] transition-all duration-300 focus:text-[var(--color-primary-300)] focus:border-[var(--color-primary-300)];"
