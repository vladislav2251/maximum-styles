<script>
  ...
  onMount(async () => {
    if (typeof window !== 'undefined') {
      ...
      $(text).wysibb({
        buttons:
          'bold,italic,underline,strike,sup,sub,|,link,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright',
        hotkeys: false,
        autoresize: false,
        fonts: {
...
<textarea name="text" id="text" bind:this={description} style="resize: none;"
></textarea>
