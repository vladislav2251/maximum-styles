    ...
    <div class="container py-4 md:p-5">
        ...
        <div class="flex max-lg:flex-col  max-lg:items-start items-center max-md:gap-1 justify-between">
            <div class="flex gap-2 items-center my-5">
                ...
                <a href="/cart">
                    <button type="button" class="bg-[var(--color-white)] px-8 py-4 flex justify-between items-center border border-solid border-[var(--color-gray)] transition-all duration-300 hover:bg-[var(--color-white200)]">{translation?.main?.popular_product?.add_to_cart}</button>
                </a>
            </div>
